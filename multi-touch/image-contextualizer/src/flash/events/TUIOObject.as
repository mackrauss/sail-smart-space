...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
		...
		public function getTouchOldPoint():Point
		{
			var oldPoint:Point;
			oldPoint = TUIO_OBJECT.parent.globalToLocal(new Point(oldX, oldY));							
			return oldPoint;
		}
		public function getTouchNewPoint():Point
		{
			var newPoint:Point;
			newPoint = TUIO_OBJECT.parent.globalToLocal(new Point(x, y));							
			return newPoint;
		}
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
// INTERNAL METHODS
